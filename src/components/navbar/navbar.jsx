...
import dataMenu from "../../asset/data/dataMenu";
...
const Navbar = () => {
  ...
  return (
    <div className="navbar">
      ...
      <div className="btn">
        <Button color="green" className='btn-bookRom'>BOOK NOW</Button>
      </div>
      <div className="menuRight">
        <div className="menu" id="menu">
          ...
          <Header as='h1' className='header'>PACKAGES</Header>
          <div className="card">
            {dataMenu.map((item) => (
              <div className="image" key={item.id}>
                ...
                <div className="inf" style={{marginLeft:15}}>
                  ...
                  <div className="add">
                    <Icon disabled name='map marker alternate' className='icon' />
                    <h4>{item.add}</h4>
                  </div>
